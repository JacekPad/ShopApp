...
//TODO filter for before / after date? (new filter with different params before date, after date?, is modified param even needed?)
//    TODO change entity boolean to string and put true/false instead (tinyint sucks)
